...
<div class="position-relative outer">
    ...
    <div class = "container py-5">
        <div style="margin-top:100px;text-align:center;">
            ...
            <h1 class="title wow fadeInUp text-bawah" >RIO DE JANEIRO</h1>
                ...
                <div class="col-lg-4 col-sm-6 order-lg-1 order-sm-2 order-2 mt-lg-5" style="padding:15px ">     
                    <div class="kotak" >
                        ...
                        <div class="kotak-dalam">
                            ...
                            <img src="{{ asset('images/voting-stellar/CoorlyBones.png') }}">
                        </div>
                        <h5 class="title wow fadeInUp juara-2" > Coorly Bones </h5>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 order-lg-2 order-sm-1 order-1 offset-sm-3 offset-lg-0 "style="padding:15px ">
                    <div class="kotak">
                        ...
                        <div class="kotak-dalam">
                            ...
                            <img src="{{ asset('images/voting-stellar/FACE-OFF.png') }}">
                        </div>
                        <h5 class="title wow fadeInUp juara-1" > FACE-OFF </h5>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 order-lg-3 order-sm-2 order-3 mt-lg-5"style="padding:15px ">
                    <div class="kotak">
                        ...
                        <div class="kotak-dalam">
                            ...
                            <img src="{{ asset('images/voting-stellar/AaronNathanael.png') }}">
                        </div>
                        <h5 class="title wow fadeInUp juara-3" > Aaron Nathanael </h5>
                    </div>
                </div>
            </div>
        </div>
        <div class="row col-12 mt-3 mx-0 "style="justify-content: space-evenly">
                <div class="col-lg-4 col-sm-6" style="padding:15px">
                    <div class="kotak">
                        ...
                        <h5 class="title wow fadeInUp juara-1" > <span> 27 </span> </h5> 
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6"style="padding:15px">   
                    <div class="kotak">
                        <h3 class="title wow fadeInUp text-atas" > JUARA </h3>
                        <h1 class="title wow fadeInUp text-bawah" > CASSIOPEIA </h1>
                        <div class="kotak-dalam mt-5">
                            <img src="{{ asset('images/core-img/1.png') }}" class="nomor1"> 
                            <img src="{{ asset('images/voting-stellar/FACE-OFF.png') }}">
                        </div>
                        <h5 class="title wow fadeInUp juara-1" ><span> FACE-OFF </span> </h5>
                    </div>
                </div>
            </div>
    </div>
