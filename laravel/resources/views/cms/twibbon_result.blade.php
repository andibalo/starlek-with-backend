...
<div class="container col-sm-8 pt-5 pb-5">
    <div style="margin-top: 100px; text-align: center;">
        ...
        <div class="mt-5 mx-3">
            <div class="wow fadeInUp" style ="max-width:600px;position: relative;margin:auto;padding:0;" id = "frame" >
    ...
    window.onload = function () {
        ...
        document.getElementById('download').addEventListener('click', () => {
            if (flag) {
                ...
                photo.width = min;
                photo.height = min;
                photo.getContext('2d').drawImage(canvas, 0, 0, min, min);
                photo.getContext('2d').drawImage(img, 0, 0, min, min);
                photo.toBlobHD((blob) => {
                    saveAs(blob, "Twibbon Starlight 2020.png");
                }, "image/png");
            }
