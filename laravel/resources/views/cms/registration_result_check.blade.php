...
@section('custom_css')
<!-- Custom CSS -->
<link rel="stylesheet" href="{{ asset('css/cms/registration_check2.css') }}">
<style>
    #main {
        @if (session('msg')=='fail')  
	...
	.custom-written-text {
		text-shadow: 0 0 0.5rem rgba(0,0,0, .75);
		color: white;
...
<div id="main">
    <div class="results-success-video @if (session('msg') != 'success') d-none @endif">
        <!--Taro VIDEO LOLOS-->
        <video id="video" src="{{ asset('images/bg-img/l_rio1.mp4') }}" muted no-controls autoplay loop style="object-fit:cover; width:100%; height:100%">
            ....
        </video>
    </div>
...
<script>
    ...
    var successContent2 = "On behalf of the entire crew, we would like to congrulate you for your incredible performance through the Mardi Gras Stage";
    var successContent3 = "Atas nama seluruh awak pesawat yang bertugas, kami mengucapkan selamat atas penampilan Anda yang luar biasa pada panggung Mardi Gras. Kami juga menyambut Anda untuk bergabung menuju destinasi selanjutnya, Rio De Janeiro!";
    ...
    var eleSuccess = "<h2 class='custom-written-text'>" + successContent1.split("").join("</h2><h2 class='custom-written-text'>") + "<br>" + successContent2.split("").join("</h2><h2 class='custom-written-text'>") + "<br><br>" +  successContent3.split("").join("</h2><h3 class='custom-written-text mt-3'>") + "<br>" + successContent4.split("").join("</h3><h3 class='custom-written-text mt-3'>") + "</h3>";
