                ...
                <div class="classy-menu">
                    ...
                    <div class="classynav">
                        <ul id="nav" style="cursor:pointer;">
                            ...
                            <li id="nav_stellar" class="nav_ f-poppins @if ($nav_menu == 'voting_stellar') active @endif"><a href="{{ route('vote') }}" > Voting Stellar </a></li>
                            <li id="nav_contact" class="nav_ f-poppins @if ($nav_menu == 'contact') active @endif"><a href="{{ route('contact') }}" > Contact </a></li>
                            
                        </ul>
                        
                        <a class="btn starlight-btn mt-3 mt-lg-0 ml-3 ml-lg-5" href="{{ route('announcement') }}"> ANNOUNCEMENT <i class="fas fa-angle-right"></i></a>
                    </div>
                    <!-- Nav End -->
                </div>
            </nav>
