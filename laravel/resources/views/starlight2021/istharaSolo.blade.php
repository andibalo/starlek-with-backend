...
<link rel="stylesheet" href="{{asset('css/starlight2021/pages/istharaSolo.css')}}" />
...
<script>
    ...
    $('#step-2 input').on("change keyup", (e) => {
        if (validate.single($('#e-mail').val(), {
                presence: true,
                email: true
            }) || validate.isEmpty($('#line-id').val()) || validate.single($('#phone-number').val(), {
                numericality: true
            }) || validate.isEmpty($('#instagram').val())) {
